...
typedef void (CALLBACK* DIVICEEVENTCALLBACK)(CString Device_List);
...
public:
	...
	void					SetDeviceCallback(DIVICEEVENTCALLBACK pDeviceCallback);
...
private:
	...
	static DWORD WINAPI		DeviceCallBackThread(LPVOID pPtr);
};
